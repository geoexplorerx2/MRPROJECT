            ...
            <div className='w-[50%] h-full relative'>
              ...
              <div className='w-full h-full'>
                <ul className='w-full m-3 list-none'>
                    ...
                    <li className='flex'><div className='w-[40px] h-[40px] rounded-full bg-white flex justify-center items-center mt-4 p-[1px]'><img className='w-full h-full' src={Email}/></div><div className='flex translate-y-[10px] items-center ml-3 text-2xl text-white'>1234</div></li>
